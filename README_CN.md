...
方式1：通过 ghp.ci 代理脚本
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/MJscofield/cursor-vip/releases/download/latest/install.sh) bb812b804d3ace65c213c5bb68bcf7f8
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://github.com/MJscofield/cursor-vip/releases/download/latest/i.sh) bb812b804d3ace65c213c5bb68bcf7f8
```
